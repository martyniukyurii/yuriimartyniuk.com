...
export function ContactsSection() {
  ...
  return (
    <section id="contacts" className="min-h-screen flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-white/5 dark:bg-gray-800/30 backdrop-blur-md rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="name" className="block text-sm font-medium mb-1">{t('contacts.form.name' as TranslationKey)}</label>
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium mb-1">{t('contacts.form.email' as TranslationKey)}</label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                    <IconMail size={18} />
                  </span>
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium mb-1">{t('contacts.form.message' as TranslationKey)}</label>
                <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:yura.martin@icloud.com" className="text-blue-400 hover:underline text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://t.me/gay_control" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      @gay_control
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+380509525558" className="text-blue-400 hover:underline text-sm">
                      +380 50 952 55 58
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/380509525558" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      +380 50 952 55 58
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="viber://chat?number=%2B380509525558" className="text-blue-400 hover:underline text-sm">
                      +380 50 952 55 58
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://discord.com/users/yuriimartyniuk03" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      yuriimartyniuk03
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.linkedin.com/in/yurii-martyniuk-488a72326/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      yurii-martyniuk
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.facebook.com/yuriimartyniukofficial" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.instagram.com/georg6262" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      @georg6262
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://teams.microsoft.com/l/chat/0/0?users=yura.martin@icloud.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/martyniukyurii" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      martyniukyurii
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.chess.com/member/lilkakish" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      lilkakish
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://link.clashroyale.com/?supercell_id&p=93-534ff246-3409-423c-9804-badc8a29f14d" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
                      YuraMartyn #GJ2Y289R
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://maps.app.goo.gl/TuR3p21qDL1Ud7GDA" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline text-sm">
